  ...
  selectFarmer() {
    ...
    dialogRef.afterClosed().subscribe((result) => {
      ...
      this.farmerstatementForm.patchValue({
        ...
        farmerId: this.dialogData.data.id
      });
    });
  }
  onSubmit() {
    console.log("Form data " + this.farmerstatementForm.controls.farmerId.value)
    this.service.generatefarmerStatement(this.farmerstatementForm.controls.farmerId.value)
      .subscribe(
        (response) => {
